                ...
                <div className="recent-work ">
                    <div className="container">
                        <div className="left-text">
                            ...
                            <p className="para">This Policy details our commitment to protecting the privacy of individuals who:<br /><br />
                            ...
                            <p className="para"> For this Policy, the term Websites shall refer collectively to www.indsaccrm.com as well as the other
                            ...
                            <p className="para">Account and Registration Information:<br />
                                We ask for and may collect personal information about you such as your name, address, phone number, email address, instant messaging ID, and credit card information,
                                as well as certain related information like your company name and website name, when you register for an account to access or utilize one or more of our Services.
                                We also ask for and collect personal information such as an email address and a name or alias from any individual that you authorize to log into and utilize our Services in
                                connection with Your Account. We base the processing of your personal information on our legitimate interest,
                                to provide you with the necessary functionality during your use of our Service.</p><br />

                            <p className="para">If you sign-up for a free trial Account, you are not required to enter your credit card information unless and until you decide to continue with a
                            ...
                            <p className="para">We refer to any information described above as Account Information for this Policy. By voluntarily providing us with Account Information, you represent that you are
                                the owner of such personal information or otherwise have the requisite consent to provide it to us.</p><br />

                            <p className="para">Other Submissions:<br />
                            ...
                            <p className="para">Attendee Information:<br />
                            ...
                            <p className="para">Mobile Application:<br />
                                ...
                                the cellular carrier facilitating connection to the mobile application, and the country the connection is arising from, to perform our obligations under our Master
                                Subscription Agreement with our Subscribers.</p><br />

                            <br /><br />

                            <h3>C. Information That We Collect From You on our Websites</h3>
                            <p className="para">Cookies and Other Tracking Technologies:<br />
                            ...
                            <p className="para">We may use web beacons, tags, and scripts on our Websites or in email or other electronic communications we
                            ...
                            <p className="para">Analytics:<br />
                                ...
                                anonymized data about your actions on our Websites with third-party service providers of analytics services. We also use mobile analytics software to allow us to
                                better understand the functionality of our mobile versions of our Services on your mobile device. This software may record information such as how often you use the
                                application, the events that occur within the application, aggregated usage, performance data, and where the application was downloaded from. We do not link the information
                                we store within the analytics software to any personally identifiable information you submit within the mobile application.</p><br />


                            <h3>D. Information Collected From Other Sources</h3>
                            <p className="para">Social Media Widgets:<br />
                                The Websites include social media features, such as the Facebook Like button, and widgets, such as the Share This button or interactive mini-programs that run on our
                                Websites. These features may collect your Internet protocol address, which page you are visiting on the Websites, and may set a cookie to enable the feature to function
                                properly. Social media features and widgets are either hosted by a third party or hosted directly on the Websites. Your interactions with these features are governed by
                                the privacy statement of the companies that provide them.
                                <br />
                                Information From Services Provided by Third Parties:</p><br />
                            <p className="para"> We may also obtain other information, including personal information, from third parties and combine that
                            ...
                            <p className="para">These single sign-on services will authenticate your identity, provide you with the option to share certain personal information (such as your name and email address)
                                ...
                                to share with others within your network.  </p><br /><br />

                            <h3>E. Other Important Privacy Information</h3>
                            <p className="para">Notice to End-Users<br />
                            ...
                            <p className="para"> Data retention<br />
                            ...
                            <p className="para">We may share Personal Data with various parties, including:<br />
                            ...
                            <p className="para">You have certain rights relating to your Personal Data, subject to local data protection laws. These rights may include:<br />
                            ...
                            <p className="para">INDSAC-CRM is the controller of your Personal Data and is responsible for its processing unless expressly
                            ...
                            <p className="para">If you have any questions about this Privacy Policy, or if you have a disability and need to access this notice in a different format,
                                please contact us here or by mail at:<br /><br />
                                support@indsaccrm.com<br />
                                info@indsaccrm.com<br /><br />
                                www.indsaccrm.com<br /><br />
                                373, Aswath Nagar, Bengaluru,<br /> 2nd Main Road, Marathahalli,<br /> Bangalore - 560037, Near Annapoorna Theatre
                            </p><br /><br />
