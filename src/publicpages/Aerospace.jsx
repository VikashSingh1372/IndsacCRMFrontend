            ...
            <div className="row about-about">
              <div className="col-lg-4 col-md-6">
                <div className="about-grids">
                  ...
                  <p className="para">CRM software tools that target small and medium-sized businesses are seldom able to satisfy the complex requirements of aerospace companies.</p>
              ...
              <div className="col-lg-4 col-md-6 about-line-top">
                <div className="about-grids">
                  ...
                  <p className="para ">The most powerful benefit of using a CRM in aviation is that the sales team spends more time connecting with customers and developing deals, and less time analyzing data... </p>
                  <div className="mt-3 about-list">
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 about-line-top">
                <div className="about-grids">
                  ...
                  <p className="para"> Using CRM you can create much more effective and personalized marketing campaigns. CRM platforms allow you to drill down into the data and get to know your passengers and their behavior.</p>
                  <div className="mt-3 about-list">
