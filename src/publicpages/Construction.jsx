        ...
        <div class="about-inner inner2">
          <div class="container seen-w3">
            <ul class="breadcrumbs-custom-path">
              ...
              <li class="active">Construction Industry</li>
            </ul>
          </div>
        </div>
      </section>
          ...
          <div class="container">
            <div class="cwp4-two row">
              <div class="col-xl-6 cwp4-image ">
                <img src={consgif} alt="product" class="img-responsive " />
              </div>
      ...
      <section class="w3l-content-with-photo-4">
        <div class="content-with-photo4-block">
          <div class="container">
            <div class="cwp4-two row">
              <div class="col-xl-6 cwp4-image ">
                <img src={co1} alt="product" class="img-responsive " />
              </div>
              <div class="cwp4-text col-xl-6">
          ...
          <div class="container">
            <div class="cwp4-two row">
              ...
              <div class="cwp4-text col-xl-6">
                ...
                <p class="para">A lack of organization makes teamwork much harder than it has to be, as some tasks may be accidentally duplicated while others are left
              ...
              <div class="col-xl-6 cwp4-image ">
                <img src={const1} alt="product" class="img-responsive " />
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="w3l-content-with-photo-4">
        <div class="content-with-photo4-block">
          <div class="container">
            <div class="cwp4-two row">
              <div class="col-xl-6 cwp4-image ">
                <img src={imp1} alt="product" class="img-responsive " />
              </div>
              <div class="cwp4-text col-xl-6">
        ...
        <div class="content-with-photo4-block">
          <div class="container">
            <div class="cwp4-two row">
              ...
              <div class="col-xl-6 cwp4-image ">
                <img src={const2} alt="product" class="img-responsive " />
              </div>
            </div>
          </div>
        </div>
