  ...
  useEffect(() => {
    $(document).ready(function () {
      ...
      if (!$.fn.DataTable.isDataTable('#example2')) {
        ...
        buttons2.container().appendTo($('#example2_wrapper .col-md-6:eq(0)'));
      }
                  ...
                  <div id="example2_wrapper" className="dataTables_wrapper dt-bootstrap4">
                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        <Table id="example2" bordered striped hover responsive>
                          <thead>
                            <tr role="row">
                              <th className="sorting sorting_desc" tabIndex="0" aria-controls="example2" rowSpan="1" colSpan="1" aria-label="Rendering engine: activate to sort column ascending" aria-sort="descending">
                                Task Id
                              </th>
